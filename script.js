window.addEventListener("load", () => {
    ...
    let gameState = "mainMenu"; // Estados: "mainMenu", "running", "paused", "controls", "credits", "upgrade"
    ...
    // =================================================================
    // NOVO/MODIFICADO: Lógica de Menus (setGameState)
    // =================================================================
    function setGameState(newState) {
        ...
        // Antes de mudar, guarda o estado atual se estivermos indo para CONTROLES
    ...
    function triggerGameOver(){ isGameOver=true; setGameState("mainMenu"); } // Volta para o Menu Principal

    function restartGame(){
        player.level=1; player.xp=0; player.xpToNext=25; player.xpMultiplier=1.0;
    ...
    window.addEventListener("keydown", e=> {
        ...
        if((isGameOver||isVictory) && key==="r") {
            // Se estiver em Game Over/Victory, reinicia e vai para o Main Menu
    ...
    function draw(){
        ...
        // As telas de Game Over e Victory AGORA são gerenciadas pelo HTML/CSS
        if(isGameOver){
